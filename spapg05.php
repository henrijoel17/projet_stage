                                    ...
                                    <div class="dropdown dropend">
                                       <!-- <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">Action -->
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-primary"><a href="spapg12.php?lettre_id=<?php echo $aff['id_lettre'] ; ?>" class="text-white" style="text-decoration:none;">supprimer</a></button>
                                        </div>
