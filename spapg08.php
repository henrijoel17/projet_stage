...
if(isset($_POST['save']))
{
    ...
    $req=$bdd->query("INSERT INTO `spatb08`(`id_modele`, `nom_modele`)
            VALUES ('$cod_id','$nom_modele')");
                                    ...
                                    <div class="dropdown dropend">
                                       <!-- <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">Action -->
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-primary"><a href="spapg08.php?modele_id=<?php echo $aff['id_modele'] ; ?>" class="text-white" style="text-decoration:none;">suppimer</a></button>
                                        </div>
