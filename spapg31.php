...
if(isset($_POST['save']))
{
    $lib_niv_acc=$_POST['lib_niv_acc'];
   

    $cod_id=strtoupper(substr($lib_niv_acc,0,2));
    ...
    $req=$bdd->query("INSERT INTO `spatb31`(`id_niv_acc`, `lib_niv_acc`)
            VALUES ('$cod_id','$nom_navire')");
            ...
            <div class="form-group">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div>libelle </div>
                            <input type="text" class="form-control" placeholder="Entrez le nom" name="lib_niv_acc">
                        </div>
                                    ...
                                    <div class="dropdown dropend">
                                       <!-- <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">Action -->
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-primary"><a href="spapg15.php?niv_acc_id=<?php echo $aff['id_niv_acc'] ; ?>" class="text-white" style="text-decoration:none;">supprimer</a></button>
                                        </div>
