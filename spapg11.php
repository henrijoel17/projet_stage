...
if(isset($_POST['save']))
{
    $nom_calibre=$_POST['nom_calibre'];
   

    $cod_id=strtoupper(substr($nom_calibre,0,2));
    ...
    $req=$bdd->query("INSERT INTO `spatb11`(`id_calibre`, `nom_calibre`)
            VALUES ('$cod_id','$nom_calibre')");
            ...
            <div class="form-group">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div>Nom Calibre</div>
                            <input type="text" class="form-control" placeholder="Entrez le nom" name="nom_calibre">
                        </div>
                                    ...
                                    <div class="dropdown dropend">
                                       <!-- <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">Action -->
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-primary"><a href="spapg11.php?calibre_id=<?php echo $aff['id_calibre'] ; ?>" class="text-white" style="text-decoration:none;">supprimer</a></button>
                                        </div>
