...
if(isset($_POST['save']))
{
    $libelle_phyto=$_POST['libelle_phyto'];
   

    $cod_id=strtoupper(substr($libelle_phyto,0,2));
    ...
    $req=$bdd->query("INSERT INTO `spatb12`(`id_phyto`, `libelle_phyto`)
            VALUES ('$cod_id','$libelle_phyto')");
...
<head>
    ...
    <title>page produit phythosanitaire</title>
</head>
<body>
                                    ...
                                    <div class="dropdown dropend">
                                       <!-- <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">Action -->
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-primary"><a href="spapg07.php?phyto_id=<?php echo $aff['id_phyto'] ; ?>" class="text-white" style="text-decoration:none;">suppimer</a></button>
                                        </div>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <div class="container">
                                                <div class="mb-3">
                                                    <div>Nom du produit phytosanitaire</div>
                                                    <input type="text" class="form-control" placeholder="Entrez votre nom" name="nom_conducteur">
                                                </div>
