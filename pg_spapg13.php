...
if(isset($_GET['save']))
{
    ...
    $req=$bdd->query("INSERT INTO `spatb13`(`id_pays`, `nom_pays`) VALUES ('$cod_p','$nom_p');");
    ...
    <form action="" method="get">
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Ajouter Pays</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
							<div class="row formtype">
                                <div class="col-md-4">
									<div class="form-group">
										<label>Id Pays</label>
										<input class="form-control" type="text" placeholder="Entrez le nom" name="id_pays">
                                    </div>
								</div>
                                <div class="col-md-4">
									<div class="form-group">
										<label>Nom Pays</label>
										<input class="form-control" type="text" placeholder="Entrez le prenom" name="nom_pays">
                                    </div>
								</div>
            ...
            <div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Table Pays</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
