...
if(isset($_POST['save']))
{
    ...
    $cod_id=strtoupper(substr($nom_navire,0,2));
    ...
    $req=$bdd->query("INSERT INTO `spatb15`(`id_navire`, `nom_navire`)
            ...
            <div class="form-group">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div>Nom Navire</div>
                            <input type="text" class="form-control" placeholder="Entrez le nom" name="nom_navire">
                        </div>
                                    ...
                                    <div class="dropdown dropend">
                                       <!-- <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">Action -->
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-primary"><a href="spapg15.php?navire_id=<?php echo $aff['id_navire'] ; ?>" class="text-white" style="text-decoration:none;">supprimer</a></button>
                                        </div>
